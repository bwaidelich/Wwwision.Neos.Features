...
use Wwwision\Neos\Features\Adapter\ForFlushingCachesViaFlow;
...
final class FeatureSystemFactory
{
    public function __construct(
        ...
        private readonly ForFlushingCachesViaFlow $forFlushingCaches,
    ) {}

    public function create(): FeatureSystem
    {
        return new FeatureSystem($this->featureProvider, $this->forStoringFeatureStates, $this->featureContext, $this->forFlushingCaches);
    }
